                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="search_date" type="text" class="form-control pull-right" id="reservation" value="">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                ...
                                @foreach ($result as $key => $item)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>{{ $item->slug }}</td>
                                        @if($item->is_active != 0)
                                            <td><span class="glyphicon glyphicon-ok text-green"></span></td>
                                        @else
                                            <td><span class="glyphicon glyphicon-remove text-red"></span></td>
                                        @endif
                                        <td class="">
                                            <form class="row" method="POST" action="{{ route('admin.product-category.remove', ['id' => $item->id]) }}" onsubmit = "return confirm('Chắc chắn xoá?')">
